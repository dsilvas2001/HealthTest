...
@Component({
  selector: 'app-testqueesansiedad',
  templateUrl: './testqueesansiedad.component.html',
  styleUrls: ['./testqueesansiedad.component.css']
})
export class TestqueesansiedadComponent {
