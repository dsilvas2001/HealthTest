...
@Component({
  selector: 'app-estadisticasuser',
  templateUrl: './estadisticasuser.component.html',
  styleUrls: ['./estadisticasuser.component.css']
})
export class EstadisticasuserComponent {
    ...
    ngOnInit(){
      this.cargarIcons();
      this.contador();
      this.contadorpsicologo();
      this.contadoradministrador();
  
  }

  contadorusuario: number;
  contadoradmin: number;
  contadorpsicologos: number;
  ...
  contadorpsicologo()
  {
    this.service.gettotalpsicologo().subscribe((data) => {
      console.log('Objecto pacientes: ', data);
      this.contadorpsicologos = data;
    });
  }

  contadoradministrador()
  {
    this.service.gettotaladmin().subscribe((data) => {
      console.log('Objecto pacientes: ', data);
      this.contadoradmin = data;
    });
  }
