...
@Component({
  selector: 'app-testdepresioninfo',
  templateUrl: './testdepresioninfo.component.html',
  styleUrls: ['./testdepresioninfo.component.css']
})
export class TestdepresioninfoComponent {
