...
@Component({
  selector: 'app-contactanosadmin',
  templateUrl: './contactanosadmin.component.html',
  styleUrls: ['./contactanosadmin.component.css']
})
export class ContactanosadminComponent {
